...
// illegalop.c
void	set_illegalop_handler(void (*handler)(struct UTrapframe *utf));
...
int     sys_vcprintf(const char *fmt, va_list ap);
int     sys_cgetc(void);
...
int	sys_env_set_illegalop_upcall(envid_t env, void *upcall);
